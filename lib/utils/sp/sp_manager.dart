import 'package:wallpaper/data/bean/UpdateProfileReq.dart';
import 'package:wallpaper/utils/constant/PrefConst.dart';
import 'package:wallpaper/utils/sp/sp_helper.dart';
...
class SPManager {
  ...
  static Future<String> getAccessToken<T>() async {
    var spValue =
        await SPHelper.getPreference(PrefConst.PREF_ACCESS_TOKEN, "");
    return spValue;
  }
